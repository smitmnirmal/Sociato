...
public class Request extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Manage Request");
        ...
        mProgress.setTitle("Loading Requests...");
        mProgress.setMessage("Please wait...");
        mProgress.setCancelable(false);
        mProgress.setIndeterminate(true);

        recyclerView=(RecyclerView)getActivity().findViewById(R.id.rv_request);
        ...
        if(count<1){
            ...
            Snackbar.make(view,"Sorry you have no request pending",Snackbar.LENGTH_LONG).setAction("Action", null).show();
        }
                                                ...
                                                try {
                                                    ...
                                                    if(receivedRequest.toString().contains(userid)){
                                                        if(!avatarurl.equals("null")){
                                                            connection connection= new connection(avatarurl,username,"Accept Request",userid,"Decline Request");
                                                            connectionList.add(connection);
                                                        }
                                                        else {
                                                            connection connection= new connection("none",username,"Accept Request",userid,"Decline Request");
                                                            connectionList.add(connection);
                                                        }
                                                    ...
                                                    /*else{
                                                        if(!avatarurl.equals("null")) {
                                                            connection connection = new connection(avatarurl, username, "Send Request", userid);
                                                            connectionList.add(connection);
                                                        }
                                                        else {
                                                            connection connection = new connection("none", username, "Send Request", userid);
                                                            connectionList.add(connection);
                                                        }
                                                        connectionAdapter.notifyDataSetChanged();
                                                    }*/
